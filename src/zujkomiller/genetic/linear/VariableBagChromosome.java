...
/**
 * A VariableBagChromosome has a variable number of values,
 * so that Chromosomes in the same Generation may be of different
 * lengths. Also, its values may contain duplicates - it is a
 * bag rather than a set.
 */
public class VariableBagChromosome extends LinearChromosome {

    public VariableBagChromosome(short[] argGenes) {
        super(argGenes);
    }
